...
namespace MMD_Website_AfricaC
    ...
    public partial class Reports : System.Web.UI.Page
        ...
        protected void Page_Load(object sender, EventArgs e)
            ...
            var connectionString = ConfigurationManager.ConnectionStrings["mmdonline"].ConnectionString;
            using (OracleConnection con = new OracleConnection(connectionString))
                ...
                using (OracleCommand cmd = con.CreateCommand())
                    ...
                    try
                        {
                        con.Open();
                        cmd.CommandText = "SELECT * FROM MMD_G_STAFF WHERE ENABLED = 1 and lower(Domain || '\\' || username) = '" + userName.ToLower() + "' ";
