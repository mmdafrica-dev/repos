<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SpeedTest.aspx.cs" Inherits="MMD_Website_AfricaC.SpeedTest" %>
    ...
    <script type="text/javascript">
        ...
        function startStop() {
            if (w != null) {
                ...
                w = new Worker('/Content/speed/speedtest_worker.min.js');
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <h1>MMD Internal - HTML5 Speedtest</h1>
</asp:Content>
