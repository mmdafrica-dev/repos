Function ExvbSOR13_POSTSCREEN_ALL(Param1, Param2, Param3, Param4, Param5)
Dim trgReturnValue
trgReturnValue = True
...
If rd = "REVIEWED" And trgReturnValue = True Then
  ...
  xml.Send  
End If
ExvbSOR13_POSTSCREEN_ALL = trgReturnValue
End Function

Function EXVBSOR13_PRESCREEN_ALL(Param1, Param2, Param3, Param4, Param5)
Dim trgReturnValue
trgReturnValue = True
Dim x
x = disablefield("IO-SPARE-1")
EXVBSOR13_PRESCREEN_ALL = trgReturnValue
End Function
